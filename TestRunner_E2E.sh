...
WS_DIR=Workspace
REPO_NAME=TitleValidation_E2E
ARTIFACT_NAME=TitleValidation_E2E
APP_VERSION=1.2
MAIN_CLASS=core.SeleniumWithFirefox
ARGS_01=
# ========================================
# ========================================
# GITHUB_ACCOUNT=$1
...
mvn clean site test -Dtest=AllTest -Dbuild.version=$APP_VERSION
